...
function defaultKeySelector<P extends unknown[]>(...args: P): CacheKey {
  return args[0] as CacheKey ?? nanoid(16);
}
function defaultEmptyPredicate(page: Page<unknown>): boolean {
...
useEnumerableBinder.defaultKeySelector = defaultKeySelector;
useEnumerableBinder.defaultEmptyPredicate = defaultEmptyPredicate;
...
useIndexableBinder.defaultKeySelector = defaultKeySelector;
useIndexableBinder.defaultEmptyPredicate = defaultEmptyPredicate;
